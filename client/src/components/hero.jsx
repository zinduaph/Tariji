...
const Hero = () => {
    ...
    return (
        ...
        <div className=" flex flex-col ml-3 justify-center mt-10 items-center pt-10 ">
            <h1 className="border  border-gray-300 w-80 md:w-100 p-2 rounded-full text-gray-500">sell your digital products in seconds</h1>
            <h2 className="ml-4 mt-10 md:text-6xl text-3xl font-semibold text-white">Turn your <span className="text-orange-500">creations</span> into <span className="text-orange-500">cash</span></h2>
